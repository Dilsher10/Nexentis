...
const Navbar = () => {
    ...
    return (
        <>
            <div class="nexentis_header">
                <div class="h-100 container">
                    <div class="h-100 row">
                        <div class="mt-auto mb-auto col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-6">
                            <div class="nexentis_logo">
                                <Link href="/">
                                    <img src="/logo.png" alt="" />
                                </Link>
                            </div>
                        </div>
                        <div class="mt-auto mb-auto col-xxl-10 col-xl-10 col-lg-10 col-md-9 col-6">
                            <div class="navicon text-end">
                            </div>
                            <nav class="nexentis_menu deskstop_view text-end">
                                <ul>
                                    <li><Link href="/" class="nav_link">Home</Link></li>
                                    <li class="mega"><Link href="" class="nav_link">Services</Link>
                                        <div class="mega_menu">
                                            <div class="container">
                                                <div class="lightbg_menu row">
                                                    <div class="m-auto col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="cateorgy_namee">
                                                            <h4 class="ps-0">Our Services</h4>
                                                            <div class="menu_content"><img
                                                                src="/service.webp"
                                                                class="img-fluid" alt="mobile app development company" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="cateorgy_namee">
                                                            ...
                                                            <ul class="menu_items">
                                                                ...
                                                                <li><a href="/android-app-development">Android
                                                                    App Development</a></li>
                                                                <li><a href="/ios-app-development">iOS
                                                                    App Development</a></li>
                                                                <li><a href="/cross-app-development">Cross
                                                                    App Development</a></li>
                                                                <li><a href="">Game
                                                                    Development</a></li>
                                                                <li><a href="">Web
                                                ...
                                                <div class="darkbg_menu row">
                                                    <div class="m-auto col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="core_namee">
                                                            <h4 class="mb-0">Core Services</h4>
                                                        </div>
                                                    </div>
                                                    <div class="my-auto col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="core_menu">
                                                            <div class="core_icon"><svg width="27" height="41"
                                                            ...
                                                            <div class="menu_items"><a href="/">Mobile
                                                                Application<span>IOS, Android and wearable
                                                                    Apps</span></a></div>
                                                        </div>
                                                    </div>
                                                    <div class="my-auto col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="core_menu">
                                                            <div class="core_icon"><svg width="56" height="41"
                                                                viewBox="0 0 56 41" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                            ...
                                                            <div class="menu_items"><a
                                                                ...
                                                                Development<span>2D, 3D and Isometric
                                                                    Games</span></a></div>
                                                        </div>
                                                    </div>
                                                    <div class="my-auto col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-12">
                                                        <div class="core_menu">
                                                            ...
                                                            <div class="menu_items"><a
                                                                href="/custom-software-development">Software
                                                                Development<span>Startups &amp;
                                                                    Enterprises</span></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="mega"><Link href="#what-we-do" class="nav_link">What we do</Link>
                                    </li>
                                    <li><Link href="#our-projects" class="nav_link">Projects</Link>
                                    </li>
                                    <li><Link href="#why-choose-us" class="nav_link">Why choose us?</Link>
                                    </li>
                                    <li><Link href="/about-us" class="nav_link">About us</Link>
                                    </li>
                                    <li><Link href="/contact-us" class="nav_link">Contact us</Link>
                                    </li>
                                    <li><Link href="/contact" class="btn_primary">Get A Quote</Link></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div className='navigation'>
                ...
                <label class="menu-button" for="menu-toggle"><span class="menu-icon"></span></label>
                <img src="/logo.png" alt="" />
                <div class="menu">
                    <nav>
                        <ul>
                            <li class="menu-item"><Link href="/">Home</Link></li>
                            <li class="menu-item dropdown">
                                <a class="menu-item dropdown-toggle" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Service
                                </a>
                                <ul class="dropdown-menu">
                                    <li><Link class="dropdown-item" href="/mobile-app-development">Mobile App Development</Link></li>
                                    <li><Link class="dropdown-item" href="/android-app-development">Android App Development</Link></li>
                                    <li><Link class="dropdown-item" href="/ios-app-development">iOs App Development</Link></li>
                                    <li><Link class="dropdown-item" href="/cross-app-development">Cross App Development</Link></li>
                                </ul>
                            </li>
                            <li class="menu-item"><Link href="/about-us">About Us</Link></li>
                            <li class="menu-item"><Link href="/contact-us">Contact Us</Link></li>
                        </ul>
                    </nav>
                </div>
            </div>
